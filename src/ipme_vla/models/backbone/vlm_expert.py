...
except ImportError:  # Optional unless a LoRA/PEFT policy is requested.
...
class VisionLanguageActionBackbone(nn.Module):
    def __init__(
        self,
    ...
    def configure_peft(self, config):
        ...
        if "lora" in self.peft_method:
            if get_peft_model is None:
                raise ImportError("PEFT is required when peft_method contains 'lora'; install the 'peft' package")
